  ...
  return (
    <div className={sidebarClassnames}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        {/* Top Logo */}
        <div className="z-50 flex min-h-[56px] w-64 item-center justify-between bg-white px-6 pt-3 dark:bg-black">
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray=200 px-8 py-4 dark:border-gray-700">
          <Image src="https://project-mgmt-s3-images.s3.us-east-1.amazonaws.com/logo.png" alt="Logo" width={40} height={40}></Image>
          <div>
        ...
        {/* Priorities LINKS */}
        <button onClick={() => setShowPriorities((prev) => !prev)}
          className='flex w-full items-center justify-between px-8 py-3 text-gray-500'
        >
